...
class PreChekinController with MessagesStateMixin {
  PreChekinController({
    required CallNextPatientService callNextPatientService,
  }) : _callNextPatientService = callNextPatientService;

  //a regra de negocio de chamar o proximo paciente
  final CallNextPatientService _callNextPatientService;

  //era pra ser privado, mas vai utilizar outra logica
  ...
  Future<void> next() async {
    ...
    switch (result) {
      ...
      case Right():
        showInfo('Nenhum paciente no aguardo!');
    }
  }
}
